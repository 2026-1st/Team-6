# 피처 엔지니어링 노트북 코드 설명 및 결과 해석

이 문서는 `notebooks/02_feature_engineering/Feature_Engineering.ipynb`에서 수행하는 2단계 피처 엔지니어링 과정을 정리한 문서입니다.
...
노트북 첫 코드 셀에서는 Google Drive를 마운트하고 프로젝트 경로를 설정합니다.
